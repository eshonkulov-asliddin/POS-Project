...
def online_hisobot_oynasiga_otish():
    root.destroy()
    import online_hisobot
...
loginButton1 = Button(root, text="Login", command=online_hisobot_oynasiga_otish, height=1, font="bold")
cancelButton3 = Button(root, text="Cancel", command=quit, height=1, font="bold")
